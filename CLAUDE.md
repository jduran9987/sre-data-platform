...
- **Match the register to the writing — dry is the default, everywhere.** Two modes, and you MUST know which you're in. The **only** exception to dry, informational language is the business story / scenario of a project (see Creative writing below); for everything else — docs, instructions, and chat alike — you MUST use the informational register.
  - **Informational writing** — explanations, guides, requirements, status, setup, project and module descriptions, and all chat responses. You MUST write **dry, straight-to-the-point, structured, and informative**: no cute or clever framing, no fourth-wall asides, no throat-clearing ("this is the most important section…"), no rhetorical build-up, no conversational filler. Give concrete definitions, not loose description. State what is true and move on. Prefer structure — short sections, bold lead-ins, bullet lists — over dense paragraphs.
